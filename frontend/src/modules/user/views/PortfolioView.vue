...
import AnalysisBuffett         from "@/modules/user/components/analysis/AnalysisBuffett.vue";
import AnalysisMagicFormula    from "@/modules/user/components/analysis/AnalysisMagicFormula.vue";
